...
function this:init()
    if getConfig('teams:enable') then
        ...
        commands.add_command('team-create', {'teams:help.invite-accept'}, teams.commands.inviteAccept)
        commands.add_command('team-create', {'teams:help.invite-cancel'}, teams.commands.inviteCancel)
